...
#         new_vector = np.array([xc, yc, zc])
#         all_lig_vectors.append(new_vector)
#         print(len(all_lig_vectors)) # 1050
#         # for model in structure:
#         #     for chain in model:
...
# first = lig_vectors[0]
# # for lig_vectors[1] in len(lig_vectors):  # 37-51  строит все возможные векторы из массива (210шт)
# #     vector =lig_vectors[0]
# vector = first
# print(vector)
...
for x in range (len(lig_vectors)):  # 37-51  строит все возможные векторы из массива (210шт)
    ...
    for i in range(5):
        ...
        if 0 not in check_structure:
            good_vectors.append(vector)
        # print(lig_coor) # разные
        # print(cdx_coor) # одинаковые в каждой итерации
        lig_coor.clear()
        cdx_coor.clear()

print(len(lig_vectors)) # 210 шт
print(lig_vectors) 
print(len(good_vectors)) #1 но он соответствует lig_vectors[0]
print(good_vectors)
